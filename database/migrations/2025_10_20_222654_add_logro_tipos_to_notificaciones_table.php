...
return new class extends Migration
{
    ...
    {
        DB::statement("ALTER TABLE notificaciones MODIFY COLUMN tipo ENUM('comentario','asignacion','recordatorio','cambio_estado','mencion','sistema') NOT NULL DEFAULT 'sistema'");
    }
};
